...
namespace CC_Q1_Northwind
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "fn_GetCustomerDetails")]
        public virtual IQueryable<fn_GetCustomerDetails_Result> fn_GetCustomerDetails(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetCustomerDetails_Result>("[NorthwindEntities].[fn_GetCustomerDetails](@country)", countryParameter);
        }
